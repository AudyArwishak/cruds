    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Tambah Jadwal Pengiriman</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="{{ route('jadwalpengiriman.store') }}" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                            @csrf
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="date" name="tanggal_pengiriman" id="last-name" name="last-name" required="required" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
