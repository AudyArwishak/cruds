        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right top_search">
                    <a href="{{ route('jadwalpengiriman.create') }}">
                        <button class="btn btn-primary"> <i class="fa fa-plus"></i></button>
                    </a>
                    <a href="{{ url('print-jadwalpengiriman') }}" target='_blank' <button class="btn btn-primary"> <i class="fa fa-clipboard"></i></button>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="x_content">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('jadwalpengiriman.edit', ['id' => $pgw->id_jadwal]) }}">
                                            <button class="btn btn-info" type="button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </a>
                                        <form action=""></form>
                                        <form action="{{ route('jadwalpengiriman.destroy', ['id' => $pgw->id_jadwal]) }}" method="delete">
                                            @csrf
