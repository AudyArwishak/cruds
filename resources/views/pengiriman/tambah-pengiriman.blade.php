        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="{{ route('pengiriman.store') }}" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="middle-name" name="jumlah_kg" class="form-control" type="text" name="middle-name">
                                </div>
                            </div>
